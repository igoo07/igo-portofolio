...
@section('title', 'Prince.Igo | About Me')
        ...
        <div class="grid md:grid-cols-12 gap-12 items-start mb-24">
            ...
            <div class="md:col-span-7 space-y-6 pt-2">
                ...
                <div class="space-y-5 text-slate-400 leading-relaxed text-justify border-l border-slate-800 pl-6 ml-1">
                    <p>
                        Informatics graduate with a core expertise in
                        <span class="text-white font-semibold">Software Engineering,</span>.
                        specifically in Front-End development using the Laravel framework. Experienced as a
                        <span class="text-white font-semibold">Digital Marketing</span>.
                        Staff, which honed communication skills, teamwork, and detail-orientation in analyzing digital user
                        needs.
                    </p>
                    <p>
                        Internationally Certified
                        <span class="text-blue-400 italic">Oracle Certified
                            Foundations Associate</span>, which strengthens a fundamental understanding of information
                        technology.
                    </p>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div
                    ...
                    <span
                        ...
                        — 2025</span>
                    <h4 class="text-white font-bold text-xl mb-1">Bachelor of Informatics</h4>
                    <p class="text-slate-400 text-sm">International University of Semen Indonesia</p>
                </div>
                ...
                <div
                    ...
                    <span
                        ...
                        — 2021</span>
                    <h4 class="text-white font-bold text-xl mb-1">Online Business & Marketing</h4>
        ...
        <div class="bg-slate-900/50 border border-slate-800 p-8 md:p-10 rounded-3xl">
            ...
            <div class="max-w-5xl mx-auto p-4 flex flex-col gap-6">
                ...
                <div
                    ...
                    <div
                        class="relative w-full md:w-44 h-28 flex-shrink-0 rounded-xl overflow-hidden bg-slate-900 shadow-inner">
                    ...
                    <div class="flex-grow text-center md:text-left">
                        ...
                        <p class="text-slate-500 text-sm">Published January 2025</p>
                    </div>
                    <div class="w-full md:w-auto">
                        <a href="images/oracle.jpg" download="Sertifikat_Oracle.jpg"
                            class="inline-block w-full text-center px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-blue-500/20 active:scale-95 cursor-pointer">
                            Download PDF
                        </a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        class="relative w-full md:w-44 h-28 flex-shrink-0 rounded-xl overflow-hidden bg-slate-900 shadow-inner">
                        <img src="images/ecpt.jpg" alt="ECPT Certificate"
                            class="w-full h-full object-cover opacity-50 group-hover:opacity-100 transition-all duration-700 scale-105 group-hover:scale-110">
                    </div>
                    <div class="flex-grow text-center md:text-left">
                        <p class="text-blue-500 font-bold uppercase tracking-widest text-[9px] mb-2">Language</p>
                        <h4 class="text-white font-bold text-xl mb-1">English Communication Proficiency Test</h4>
                        <p class="text-slate-500 text-sm">Published February 2025</p>
                    </div>
                    <div class="w-full md:w-auto">
                        <a href="images/ecpt.jpg" download="Sertifikat_ECPT.jpg"
                            class="inline-block w-full text-center px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-blue-500/20 active:scale-95 cursor-pointer">
                            Download PDF
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div
                        class="relative w-full md:w-44 h-28 flex-shrink-0 rounded-xl overflow-hidden bg-slate-900 shadow-inner">
                        <img src="images/hima.jpg" alt="Himpunan Certificate"
                            class="w-full h-full object-cover opacity-50 group-hover:opacity-100 transition-all duration-700 scale-105 group-hover:scale-110">
                    </div>
                    <div class="flex-grow text-center md:text-left">
                        <p class="text-blue-500 font-bold uppercase tracking-widest text-[9px] mb-2">Organization</p>
                        <h4 class="text-white font-bold text-xl mb-1">Public Relations Staff Certificate</h4>
                        <p class="text-slate-500 text-sm">Period 2023 - 2024</p>
                    </div>
                    <div class="w-full md:w-auto">
                        <a href="images/hima.jpg" download="Sertifikat_Himpunan.jpg"
                            class="inline-block w-full text-center px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-blue-500/20 active:scale-95 cursor-pointer">
                            Download PDF
                        </a>
                    </div>
