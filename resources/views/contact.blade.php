    ...
    <div class="max-w-6xl mx-auto px-6 text-center py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="mailto:helmaesad@gmail.com"
                ...
                <p class="text-slate-400 text-xs break-all">helmaesad@gmail.com</p>
            </a>
            ...
            <a href="https://linkedin.com/in/helmaesa-diego-putra-013546351/" target="_blank"
                ...
                <h3 class="text-white font-bold mb-2">LinkedIn</h3>
                <p class="text-slate-400 text-xs">Helmaesa Diego Putra</p>
            </a>
            ...
            <a href="https://wa.me/6287823928494" target="_blank"
                ...
                <p class="text-slate-400 text-xs">0878-2392-8494</p>
            </a>
            ...
            <a href="https://github.com/igoo7" target="_blank"
                ...
                <h3 class="text-white font-bold mb-2">GitHub</h3>
